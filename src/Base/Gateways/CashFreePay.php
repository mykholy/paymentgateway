...
use mykholy\Paymentgateway\Base\GlobalCurrency;
...
use mykholy\Paymentgateway\Models\PaymentMeta;
...
//                "customer_phone" => str_replace(' ','',$customer_details->customer_phone), //+91-985-559-9234
    ...
    private function getCustomerDetails($args){
        $req = Http::withHeaders([
            ...
            "customer_phone" => $args["phone"] ?? "+919855599234",
